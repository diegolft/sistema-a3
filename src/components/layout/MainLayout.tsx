...
export function MainLayout() {
	...
	return (
		<div className="flex min-h-screen flex-col overflow-x-hidden font-sans text-neutral-100 antialiased">
			...
			>
			{/*
			 * Sem AnimatePresence aqui: durante o exit a arvore antiga continua montada e o
			 * <Outlet /> dentro dela ja renderiza a rota NOVA, duplicando a tela inteira
			 * (e com React 19 + StrictMode o exit pode nunca completar). Apenas anima a entrada.
			 */}
			<motion.div
